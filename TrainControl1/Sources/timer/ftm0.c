...
{
  if ((FTM0_C0SC & CHF_CHIE_MASK) == CHF_CHIE_MASK) FTM0CH0_IRQHandler(); //Encoder Ticks
  if ((FTM0_C1SC & CHF_CHIE_MASK) == CHF_CHIE_MASK) FTM0CH1_IRQHandler(); //Beeper sound
  ...
  if ((FTM0_C7SC & CHF_CHIE_MASK) == CHF_CHIE_MASK) FTM0CH7_IRQHandler(); //servo load
